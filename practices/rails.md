...
- Avoid [Enums](http://api.rubyonrails.org/v4.1/classes/ActiveRecord/Enum.html). They can cause non-obvious problems with ueries ([1](https://bendyworks.com/rails-enum-sharp-knife/)). Use strings instead.
